...
Das Ziel dieser Fallstudie besteht darin, ein grundlegendes Verständnis moderner Technologien zu schaffen,
diese zu vergleichen und wesentliche Begriffe zu klären.
Unter anderm soll das Zusammenspiel verschiedener Komponenten innerhalb einer Web-Anwendung verstanden werden.
...
wie eine fundierte Entscheidung über die geeignete Technologiekombination für eine Anwendung getroffen werden kann,
...
\begin{enumerate}
  ...
  \item \textbf{Nutzungsanalyse:} Untersuchung, welche Backend-Technologien von großen Unternehmen eingesetzt werden.
...
\Cref{fig:communication} zeigt den grundlegenden Unterschied zwischen REST-APIs (unten) und WebSockets (oben).
