...
Um eine \ac{WebApp} oder Website entwickeln zu können, ist es wichtig, die Struktur zu kennen.
...
In dieser Fallstudie wurde ein Einblick in moderne Webtechnologien gegeben
und die Eignung in Bezug auf der GLS Quiz App analysiert.
Die Untersuchung umfasste sowohl drei Frontend- als auch drei Backend-Frameworks,
wobei die Kriterien Lernkurve, Leichtgewichtigkeit,
Verfügbarkeit an Erweiterungen (insbesondere die Integration von Karten) sowie Zukunftssicherheit,
einschließlich Struktur und Historie, im Vordergrund standen.
...
dass die \textbf{Wahl der Kombination} aus Front- und Backend-Frameworks nicht entscheidend für den Erfolg der Implementierung ist.
Vielmehr hängt der Erfolg davon ab,
wie gut die einzelnen Frameworks unabhängig voneinander den spezifischen Anforderungen und Präferenzen des Entwicklers gerecht werden.

Aus den Ergebnissen der Fallstudie lässt sich ableiten,
dass Vue und Express die besten Frameworks für die Entwicklung der GLS Quiz App sind.
Auch mit Blick auf die Historie zeigt sich, dass Vue kürzlich eine bedeutende Weiterentwicklung durchlaufen hat,
wodurch eine Neuprogrammierung in naher Zukunft eher unwahrscheinlich ist.
...
Da die GLS Quiz App jedoch einen relativ geringen Funktionsumfang hat und das Hauptaugenmerk auf der Karten Integration liegt,
wiegt dieser Punkt weniger schwer.
