...
\section{Einleitung}
Diese Fallstudie mit dem Titel „Analyse von Web Applikations-Technologien: Am Beispiel der GLS Quiz App“
...
Unter anderem soll das Zusammenspiel der 2 Hauptkomponenten innerhalb einer \ac{WebApp} verstanden werden.
...
Bei großen \ac{WebApp}s spielt das weniger eine Rolle, aber bei kleinen \ac{WebApp}s ist das von Nachteil.
...
\ac{TS} bietet hier eine Lösung, indem es Typisierung einführt, während es nahtlos mit Express integriert werden kann. \cite{EX}
...
dass ich die vorliegende Arbeit selbständig verfasst und keine anderen als die angegebenen Hilfsmittel benutzt habe.
